...
echo ""
echo "  4. Install the Tasks community plugin (recommended for task management):"
echo "       Settings → Community Plugins → Browse"
echo "       Search 'Tasks' → Install → Enable"
echo "     No additional configuration needed."
echo ""
echo "  5. Start your agent from inside the vault:"
...
echo ""
echo "  6. Run 'natalie sync' from any directory any time you add new notes."
